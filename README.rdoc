...
For Rails 4.x apps, add to your Gemfile:
...
If you are using Rails 3.x, add:
...
Also it will add to your <tt>config/routes.rb</tt> the wiki route (change it at your will):
